...
<div>
  ## HTML & CSS
  <img width="700px" class="rounded float-start pe-4" style="padding-left: 100px" src="../img/browserhistory1.png">
  <img width="600px" class="rounded float-end pe-4" style="padding-right: 100px" src="../img/browserhistoryCSS.png">
</div>
...
<div>
  ...
  <img width="500px" class="rounded float-start pe-4" style="padding-left: 100px" src="../img/OGbulba.png">
  <img width="500px" class="rounded float-end pe-4" style="padding-right: 100px" src="../img/bulbaReplica.png">
</div>
